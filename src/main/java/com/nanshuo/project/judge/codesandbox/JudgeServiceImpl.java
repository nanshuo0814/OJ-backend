...
public class JudgeServiceImpl implements JudgeService {
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        List<JudgeCase> judgeCaseList = JsonUtils.jsonToList(judgeCaseStr, JudgeCase.class);
        assert judgeCaseList != null;
        ...
        questionSubmitUpdate.setJudgeInfo(JsonUtils.objToJson(judgeInfo));
